        ...
        <div class="container">
            ...
            <table class="table">
                <thead>
                    ...
                    <div>
                        <a class="btn btn-primary" href="add_gv.php">Thêm</a>
                    </div>
                </thead>
                <tbody>
                    ...
                    ?>
                            ...
                            <th scope="row"><?php echo $row['magv']; ?></th>
                                ...
                                <td><a href="update_gv.php?id=<?php echo $row['magv']; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                    <td><a href="delete_gv.php?id=<?php echo $row['magv']; ?>"><i class="bi bi-trash"></i></a></td>
                                <td>
                            <?php
                        }
                    }
